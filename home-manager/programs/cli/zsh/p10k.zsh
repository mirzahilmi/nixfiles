# Generated by Powerlevel10k configuration wizard on 2023-12-23 at 12:29 WIB.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='󱐋%F{default}❯'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=253
